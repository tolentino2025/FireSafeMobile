...
15. **Freemium Model**: 5 free inspections on the free tier; paywall triggers on 6th inspection
    - SubscriptionContext tracks plan state (free/monthly/annual) in AsyncStorage
    - PaywallScreen presents monthly/annual plans with feature highlights
    - Subscription section in ProfileScreen shows usage bar and upgrade button
    - IAP integration marked as TODO — ready to wire up RevenueCat or expo-in-app-purchases
